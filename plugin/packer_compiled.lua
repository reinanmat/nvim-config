...
_G.packer_plugins = {
  ...
  ["netrw.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/netrw.nvim",
  ...
  ["smartcolumn.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/smartcolumn.nvim",
  ...
  ["vim-python-pep8-indent"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-python-pep8-indent",
